...
export default async function ThankYouPage({
	...
	if (orderUserId !== user?.id)
		return redirect(`/sign-in?origin=thank-you?order=${orderId}`);
	...
	return (
		<main className='relative lg:min-h-full lg:absolute '>
			<div className=' hidden lg:block h-80 overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:px-12'>
				<Image
					fill
					...
					<div className='lg:col-start-2'>
						...
						{order._isPaid ? (
							<p className='mt-2 text-sm text-muted-foreground'>
								...
								download now. We've sent your receipt and order details to{' '}
						...
						<div className='mt-16 text-sm font-medium '>
							...
							<div className='space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground'>
								...
								<div className='flex items-center justify-between border-t border-gray-200 pt-6 text-gray-900'>
									...
									<p className='text-base'>{formatPrice(total + fee)}</p>
								</div>
							</div>
